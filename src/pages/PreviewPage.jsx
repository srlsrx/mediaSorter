/**
 * PreviewPage component displays a preview table of classified media files,
 * allows manual editing of file metadata, and initiates the move operation.
 *
 * - Shows a progress bar during file operations.
 * - Allows editing of show, season, and episode fields.
 * - Displays file status (auto-detected, modified, or not detected).
 * - Handles moving files to their destination folders.
 *
 * @component
 * @param {Object} props - Component props.
 * @param {function} props.changeView - Function to change the current view/page.
 * @param {function} props.setMovedFiles - Function to update the moved files state.
 * @returns {JSX.Element} The rendered preview page.
 *
 * @author Nico
 */
